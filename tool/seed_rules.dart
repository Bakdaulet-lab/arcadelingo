...
enum SeedRule {
  ...
  /// В `tool/confusables.csv` записано слово, которого в сиде нет: опечатка
  /// в id либо пара, внесённая «на будущее». И то и другое — молчащая запись.
  confusableWordMissing,

  /// Зеркальную пару нашли, а в `tool/confusables.csv` не записали. Сама пара
  /// нарушением не является — нарушение в том, что о ней некому будет узнать
