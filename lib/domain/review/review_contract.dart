...
abstract class ReviewSession {
  ...
  /// Сколько показов запланировано в сессии; слово, вернувшееся на повтор,
  /// занимает два. Может быть меньше цели, если к повторению готово мало
  /// слов. Не меняется до конца сессии.
  int get total;
}
