...
/// параметром `now`. Обращение к системным часам внутри этого каталога
/// запрещено и ловится `scripts/arch_check.sh` — грепом по тексту файла,
/// поэтому запрещённый вызов нельзя упоминать даже в комментарии. Таблица
/// интервалов и переходов — `.claude/skills/srs-engine/SKILL.md`, «Шаг 2 (v1)».
library;
