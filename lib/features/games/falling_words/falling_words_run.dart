...
class FallingWordsRun {
  ...
  /// Взвод перед первым падением (`SPEC.md`).
  ///
  /// Живёт рядом с временем падения, потому что это его же шкала, но самой
  /// фазы у взвода нет: чистый класс про него не знает вовсе. Взвод — про
  /// то, что человек ещё не нашёл кнопки на **экране**, а не про правила
  /// игры, и держит его виджет.
  ///
  /// **Игровое время, а не украшение**: системное «убрать анимации» его не
  /// отменяет, ровно как не отменяет падение. Человеку, который выключил
  /// анимации, кнопки нужно найти тем более.
