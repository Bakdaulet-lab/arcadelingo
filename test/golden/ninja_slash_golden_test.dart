...
void main() {
  ...
  // Рез в последний момент: кривой след клинка, половинки в разлёте, искры
  // и «×1.5». 3200 из 3500 — это 91% лимита, окно бонуса с 85%. 150 мс из
  // 300 — половина подсветки: половинки разошлись, искры на полпути, «+15»
  // ещё виден, кольцо-вспышка дожигает последнюю четверть своих 200 мс.
  testWidgets(
